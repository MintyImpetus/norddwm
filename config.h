...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#bf616a", "#3b4252", "#4c566a"},
	[SchemeSel]  = { "#5e81ac", "#434c5e",  "#5e81ac"},
};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          SHCMD("dmenu_run -c -l 16")},
	{ MODKEY,                       XK_r,      spawn,          SHCMD("alacritty --command lfub")},
	{ MODKEY,                       XK_n,      spawn,          SHCMD("alacritty --command newsboat -r")},
	{ MODKEY,                       XK_a,      spawn,          SHCMD("alacritty --command alsamixer -c 1")},
	{ MODKEY,                       XK_z,      spawn,          SHCMD("dmenuengine librewolf")},
	{ MODKEY,                       XK_v,      spawn,          SHCMD("alacritty --command discord")},
	{ MODKEY,                       XK_s,      spawn,          SHCMD("spotify")},
	{ MODKEY,  	                XK_p,      spawn,          SHCMD("passmenu -c")},
	{ MODKEY,  	                XK_y,      spawn,          SHCMD("ytfzf -D")},
	{ MODKEY|ShiftMask,             XK_c,      spawn,          SHCMD("dmenuengine chromium")},
	{ MODKEY|ShiftMask,             XK_l,      spawn,          SHCMD("slock")},
	{ MODKEY|ShiftMask,             XK_m,      spawn,          SHCMD("dmenumount")},
	{ MODKEY|ShiftMask,             XK_n,      spawn,          SHCMD("dmenuumount")},
	{ MODKEY|ShiftMask,             XK_z,      spawn,          SHCMD("emacsclient -c")},
	{ MODKEY|ShiftMask,             XK_period, spawn,          SHCMD("playerctl --player=spotify next")},
	{ MODKEY|ShiftMask,             XK_comma, spawn,           SHCMD("playerctl --player=spotify previous")},
	{ MODKEY|ShiftMask,             XK_slash, spawn,           SHCMD("playerctl --player=spotify play-pause")},
	/*System Keys VVV Application keys ^^^*/
